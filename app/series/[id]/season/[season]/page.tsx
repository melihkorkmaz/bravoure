  ...
  return (
    <>
      <div className="min-h-full flex flex-col xl:flex-row">
        <BackgroundImage className="xl:w-[65%] w-full bg-center bg-cover bg-no-repeat bg-blend-darken flex flex-col background-image" url={tvSerie?.Poster}>
...
export async function generateMetadata({ params }: TvSerieProps): Promise<Metadata> {
